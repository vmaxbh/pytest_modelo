...
def test_detalhe_Produtos(log_in):
    backpack = log_in.find_element(By.XPATH, "//*[@src='./img/bolt-shirt-1200x1500.jpg']")
    backpack.click()
    ...
    log_in.get_screenshot_as_file("testsChrome/1-home-page/report/detalheProduto2-0.png")    
    ...
    log_in.get_screenshot_as_file("testsChrome/1-home-page/report/detalheProduto2-1.png")
    time.sleep(1)
    ...
    assert price_div.text == "$15.99", "O preço esperado não foi encontrado ou é diferente de $29.99"
    print('Valor assert confirmado com Sucesso!')
    price_div = log_in.find_element(By.XPATH, "//*[@class='summary_subtotal_label']")
    assert price_div.text == "Item total: $15.99", "O preço esperado não foi encontrado ou é diferente de $29.99"
    print('Valor assert confirmado com Sucesso!')
    price_div = log_in.find_element(By.XPATH, "//*[@class='summary_tax_label']")
    assert price_div.text == "Tax: $1.28", "A taxa esperada não foi encontrada ou é diferente de $2.40"
    print('Taxa assert confirmado com Sucesso!')
    price_div = log_in.find_element(By.XPATH, "//*[@class='summary_total_label']")
    assert price_div.text == "Total: $17.27", "O preço esperado não foi encontrado ou é diferente de $32.39"
    print('Valor total assert confirmado com Sucesso!')
    time.sleep(1)
    log_in.get_screenshot_as_file("testsChrome/1-home-page/report/detalheProduto2-2.png")
    finish = log_in.find_element(By.XPATH, "//*[@class='btn_action cart_button']")
    finish.click()
    log_in.get_screenshot_as_file("testsChrome/1-home-page/report/detalheProduto2-3.png")
