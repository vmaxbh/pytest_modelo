...
def test_checkout(log_in):
    ...
    log_in.get_screenshot_as_file("testsChrome/2-checkout/report/checkout1.png")
    time.sleep(1)
    ...
    time.sleep(1)
    log_in.get_screenshot_as_file("testsChrome/2-checkout/report/checkout2.png")
    finish = log_in.find_element(By.XPATH, "//*[@class='btn_action cart_button']")
    finish.click()
    log_in.get_screenshot_as_file("testsChrome/2-checkout/report/checkout3.png")
