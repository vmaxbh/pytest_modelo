...
def test_detalhe_Produtos(log_in):
    ...
    log_in.get_screenshot_as_file("testsEdge/1-home-page/report/detalheProduto2-0.png")    
    ...
    log_in.get_screenshot_as_file("testsEdge/1-home-page/report/detalheProduto2-1.png")
    time.sleep(1)
    ...
    time.sleep(1)
    log_in.get_screenshot_as_file("testsEdge/1-home-page/report/detalheProduto2-2.png")
    finish = log_in.find_element(By.XPATH, "//*[@class='btn_action cart_button']")
    finish.click()
    log_in.get_screenshot_as_file("testsEdge/1-home-page/report/detalheProduto2-3.png")
